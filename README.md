...
Otteniamo &Gamma;<sup>+</sup>(u) &forall; u &isin; U, ovvero l'insieme di tutti i v &isin; &Gamma;(u) tali che: d(v) > d(u), tra questi si selezionano poi gli insiemi tali per cui:  
